...
for noise in [1e-5,1e-3,1e-1]:
    ...
    for seed in tqdm(range(reps), desc="ANATRA reps"):
        ...
        file = open(f"Pickle_files/Rosenbrock_{noise_type}_{n}_{noise}_ANATRA.pickle", "wb")
...
tracks_PyBobyqa = {}
for noise in [1e-5,1e-3,1e-1]:
    prob = Rosenbrock(n=n, noise_level=noise)
    ...
    file = open(f"Pickle_files/Rosenbrock_{noise_type}_{n}_{noise}_PyBobyqa.pickle", "wb")
